...
function Sponsors() {
    ...
    return (
        <div className='sponsorsMain'>
            <Navbar />
            <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className='sponsorsMain__imageFrame mt-10 flex justify-center'>
            ...
            <div className="sponsorsMain__sponsors m-6 lg:m-12 flex flex-col gap-4">
                ...
                <motion.div className="sponsorsBox flex justify-center items-center gap-16 mt-4">
                    {data.filter(ob => ob.type === "TITLE").map((item) => (
                        <div className="sponsorsMain__sponsors__card flex flex-col gap-6 p-6 h-[400px] hover:bg-[#FFEEB6] transition-all ease-in-out w-fit rounded-lg">
                            <img className='w-60' src={logosp} alt="Image not available" />
                            <p>{item.title}</p>
                ...
                <motion.div className="sponsorsBox grid grid-cols-1 md:grid-cols-3 m-auto gap-16 mt-4">
